...
module.exports = {
  mongodb: {
    ...
    ssl: process.env.ME_CONFIG_MONGODB_SSL == 'true' || mongo.ssl,  // FIX

    //sslValidate: validate mongod server certificate against CA
    sslValidate: process.env.ME_CONFIG_MONGODB_SSLVALIDATE == 'true',  // FIX

    //sslCA: array of valid CA certificates
    sslCA: [fs.readFileSync(process.env.ME_CONFIG_MONGODB_CACERT)],
    sslKey: fs.readFileSync(process.env.ME_CONFIG_MONGODB_KEY),
    sslCert: fs.readFileSync(process.env.ME_CONFIG_MONGODB_CERT),
