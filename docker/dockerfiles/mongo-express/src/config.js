  ...
  mongodb: {
    ...
    connectionOptions: {
      ...
      ssl: process.env.ME_CONFIG_MONGODB_SSL
        ?process.env.ME_CONFIG_MONGODB_SSL.toLowerCase() === 'true'
        :false || mongo.ssl,
